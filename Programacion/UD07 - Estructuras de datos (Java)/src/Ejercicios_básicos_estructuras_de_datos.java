...
//----------------------------------------------------------------------------------------------------------------------
    ...
    private static void ej3() {
        ...
        compruebaSiEstaPresente(treeSet, 1);
        compruebaSiEstaPresente(treeSet, 2);
    }
    private static void compruebaSiEstaPresente(Set<Integer> treeSet, int valor) {
        if (treeSet.contains(1)) {
            System.out.println("el valor " + valor + " esta presente");
        } else System.out.println("el valor " + valor + " no esta presente");
    }

//----------------------------------------------------------------------------------------------------------------------

    //Ejercicio 4. HashMap
    //•	Crea un “HashMap” que mapee Strings a enteros. Añade algunas entradas
    //y muestra el mapa completo.
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    private static void ej6() {
        ...
        students.add(new Student(1, "Juan", "A"));
        students.add(new Student(2, "Ana", "B"));
